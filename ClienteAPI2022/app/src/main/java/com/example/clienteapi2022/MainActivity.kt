package com.example.clienteapi2022
...
import com.example.clienteapi2022.databinding.ActivityMainBinding
            ...
            retrofit.addUser(userInfo).enqueue(
                object : Callback<Usuario> {
                    ...
                    override fun onResponse(call: Call<Usuario>, response: Response<Usuario>) {
                        ...
                        Toast.makeText(this@MainActivity, "Registro ok:  ${addedUser.toString()}",Toast.LENGTH_SHORT).show()
