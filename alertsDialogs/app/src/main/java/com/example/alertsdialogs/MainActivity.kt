...
class MainActivity : AppCompatActivity() {
    ...
    val positiveButtonClick = {
            ...
            Toast.makeText(applicationContext,"Has pulsado sí", Toast.LENGTH_SHORT).show()
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btEdicion.setOnClickListener {
            ...
            builder.setPositiveButton("OK") { dialogInterface, i ->
                Toast.makeText(applicationContext, "EditText introducido es " + editText.text.toString(), Toast.LENGTH_SHORT).show() }
            builder.show()
        }
